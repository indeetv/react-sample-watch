...
const LoadingSpinner: React.FC = () => {
  return (
    <div className="w-screen h-screen bg-slate-100 flex flex-col justify-center items-center gap-4">
      <svg
      ...
      <p className="text-xl font-semibold text-indigo-700">Loading</p>
    </div>
  );
};
